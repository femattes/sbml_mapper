...
print("read components: " + str(read_components(conn)) + "\n")

print("read regulations: " + str(read_regulations(conn)) + "\n")

print("comp reg listt: " + str(component_regulators_list(conn)) + "\n")

print("done with database_reader")